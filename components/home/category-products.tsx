...
function ProductCard({ product }: { product: Product }) {
  ...
  return (
    ...
    >
      <div className="relative aspect-square rounded-xl overflow-hidden bg-[#FAF7F2] border border-[#8C3F48]/10 mb-3 shadow-sm">
        ...
        <button 
          className="absolute top-3 right-3 w-9 h-9 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center text-[#C9A9A6] hover:text-[#8C3F48] hover:bg-white transition-all opacity-0 group-hover:opacity-100 shadow-sm"
          aria-label={`Add ${product.title} to wishlist`}
        >
          <Heart className="w-4 h-4" aria-hidden="true" />
        </button>
      </div>
      <h3 className="text-[#2C2C2C] font-medium text-sm mb-1 group-hover:text-[#8C3F48] transition-colors line-clamp-2">
        {product.title}
      </h3>
...
function CategorySection({ 
  ...
  return (
    <section className="py-12 md:py-16 border-b border-[#8C3F48]/10 last:border-b-0">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link 
            ...
            className="hidden md:inline-flex items-center gap-2 font-medium text-[#8C3F48] hover:text-[#A15D67] transition-colors text-sm tracking-wide"
          >
        ...
        <div className="mt-4 text-center md:hidden">
          <Link 
            href={`/collections/${collection.handle}`}
            className="inline-flex items-center gap-2 font-medium text-[#8C3F48] text-sm tracking-wide"
          >
...
export function CategorySectionSkeleton() {
  return (
    <section className="py-12 md:py-16 border-b border-[#8C3F48]/10">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between mb-8">
          <div>
