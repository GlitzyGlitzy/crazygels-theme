  ...
  return (
    <div ref={dropdownRef} className="relative">
      <button
        ...
        className="flex items-center gap-2 rounded-lg border border-[#8C3F48]/20 bg-[#FFFEF9] px-4 py-2.5 text-sm text-[#2C2C2C] transition-colors hover:border-[#8C3F48]/40 hover:bg-[#8C3F48]/5"
      ...
      >
        ...
        />
        {isPending && (
          <span className="ml-1 h-4 w-4 animate-spin rounded-full border-2 border-[#8C3F48] border-t-transparent" />
        )}
      </button>

      {isOpen && (
        <div
          className="absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-xl border border-[#8C3F48]/20 bg-[#FFFEF9] p-1 shadow-xl"
          role="listbox"
        >
