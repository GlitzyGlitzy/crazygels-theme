  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-xl p-6">
        ...
        <div className="bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-[#8C3F48]/10 flex items-center justify-center">
              <FolderOpen className="w-5 h-5 text-[#8C3F48]" />
            </div>
      ...
      {/* Collections Table */}
      <div className="bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-xl overflow-hidden">
        <div className="px-6 py-4 border-b border-[#8C3F48]/20">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-[#8C3F48]/10">
                ...
                <tr key={collection.handle} className="hover:bg-[#FAF7F2]/50">
                  ...
                  <td className="px-6 py-4 text-sm text-center">
                    <Link
                      ...
                      className="text-[#8C3F48] hover:text-[#A15D67] font-medium"
                    >
                      View
                    </Link>
                  </td>
      ...
      {/* Console Log Hint */}
      <div className="bg-[#FAF7F2] border border-[#8C3F48]/20 rounded-xl p-6">
...
function LoadingSkeleton() {
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-xl p-6">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <Link
              href="/admin"
              className="inline-flex items-center gap-2 text-[#2C2C2C]/60 hover:text-[#8C3F48] transition-colors"
            >
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl md:text-3xl font-light tracking-[0.1em] text-[#2C2C2C]">
                SHOPIFY <span className="font-medium text-[#8C3F48]">VALIDATION</span>
              </h1>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#8C3F48] hover:bg-[#A15D67] text-white font-medium rounded-lg transition-colors"
            >
