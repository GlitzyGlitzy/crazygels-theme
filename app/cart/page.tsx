    ...
    <div className="text-center py-16 px-4">
      <div className="max-w-md mx-auto">
        <div className="w-20 h-20 rounded-full bg-[#ff00b0]/20 flex items-center justify-center mx-auto mb-6">
          <ShoppingBag className="w-10 h-10 text-[#ff00b0]" />
        </div>
  ...
  return (
    <div className="text-center py-16 px-4">
      <div className="max-w-md mx-auto bg-[#111111] border border-white/10 rounded-2xl p-8">
        ...
        <h3 className="text-white font-bold text-lg mb-2">Cart Not Available</h3>
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="text-2xl font-black tracking-tight">
              ...
              <span className="text-white">GELS</span>
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="flex items-center gap-3 p-4 bg-[#111111] border border-white/10 rounded-xl">
            <div className="w-10 h-10 rounded-full bg-[#ff00b0]/20 flex items-center justify-center">
              <Lock className="w-5 h-5 text-[#ff00b0]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3 p-4 bg-[#111111] border border-white/10 rounded-xl">
            <div className="w-10 h-10 rounded-full bg-[#ff00b0]/20 flex items-center justify-center">
              <Truck className="w-5 h-5 text-[#ff00b0]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3 p-4 bg-[#111111] border border-white/10 rounded-xl">
            <div className="w-10 h-10 rounded-full bg-[#ff00b0]/20 flex items-center justify-center">
              <RotateCcw className="w-5 h-5 text-[#ff00b0]" />
            </div>
            <div>
              <p className="text-white font-medium text-sm">Easy Returns</p>
              <p className="text-white/50 text-xs">30-day policy</p>
            </div>
          </div>
        </div>
