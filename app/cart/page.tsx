    ...
    <div className="text-center py-16 px-4">
      <div className="max-w-md mx-auto">
        <div className="w-20 h-20 rounded-full bg-[#8C3F48]/20 flex items-center justify-center mx-auto mb-6">
          <ShoppingBag className="w-10 h-10 text-[#8C3F48]" />
        </div>
    ...
    <div className="text-center py-16 px-4">
      <div className="max-w-md mx-auto bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-2xl p-8">
        <div className="w-16 h-16 rounded-full bg-[#8C3F48]/20 flex items-center justify-center mx-auto mb-4">
          <ShoppingBag className="w-8 h-8 text-[#8C3F48]" />
        </div>
  ...
  return (
    <div className="grid lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2">
        <div className="bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-2xl overflow-hidden">
          <div className="p-6 border-b border-[#8C3F48]/10">
...
export default function CartPage() {
  return (
    <div className="min-h-screen bg-[#FAF7F2]">
      {/* Header */}
      <header className="border-b border-[#8C3F48]/20 bg-[#FAF7F2]/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2 text-[#2C2C2C]/60 hover:text-[#8C3F48] transition-colors">
              <ChevronLeft className="w-5 h-5" />
              <span>Continue Shopping</span>
            </Link>
            <Link href="/" className="text-2xl font-light tracking-[0.2em]">
              <span className="text-[#2C2C2C]">CRAZY </span>
              <span className="font-medium text-[#8C3F48]">GELS</span>
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="flex items-center gap-3 p-4 bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-xl">
            <div className="w-10 h-10 rounded-full bg-[#8C3F48]/20 flex items-center justify-center">
              <Lock className="w-5 h-5 text-[#8C3F48]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3 p-4 bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-xl">
            <div className="w-10 h-10 rounded-full bg-[#8C3F48]/20 flex items-center justify-center">
              <Truck className="w-5 h-5 text-[#8C3F48]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3 p-4 bg-[#FFFEF9] border border-[#8C3F48]/20 rounded-xl">
            <div className="w-10 h-10 rounded-full bg-[#8C3F48]/20 flex items-center justify-center">
              <RotateCcw className="w-5 h-5 text-[#8C3F48]" />
            </div>
            <div>
